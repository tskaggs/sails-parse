...
module.exports = (function () {
  ...
  var adapter = {
    ...
    destroy: function (connection, collection, options, cb) {
      ...
      if (options.where === null) {
        console.log('options.where');
        this.destroyAll(connection, collection, cb);
      } else {
        this.getParse().deleteObject(collection, options.where.id,
          function(err, res, body, success) {
    ...
    destroyAll: function (connection, collection, cb) {
      console.log('--------- destroyAll function');

      this.getParse().deleteallObject(collection,
        function(err, res, body, success) {
