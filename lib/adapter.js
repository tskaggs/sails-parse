...
module.exports = (function() {
  ...
  var adapter = {
    ...
    defaults: {
      ...
      appId: 'fWAUw41a8FHYD1eIyTS4gF0L9Q0kkAD9w3SXD1Xl',
      masterKey: '1uXklCvEnmcp854SUrK4h8NgwfStJiGTURNrvJdY',
      restKey: '8wCRXUzqd2Ubm2tXtIiH6q2ASitm9P4iWp4gN6x9',
    ...
    //   _modelReferences[connection.identity] = {
    //     config: connection,
    //     collections: {}
    //   };
    ...
    //     _modelReferences[connection.identity].connection = db;

    //     // Build up a registry of collections
    //     Object.keys(_modelReferences).forEach(function(key) {
    //       _modelReferences[connection.identity]._modelReferences[key] = new Collection(_modelReferences[key], db);
    //     });
    ...
    //   console.log(connectionObject.collections[collectionName]);
